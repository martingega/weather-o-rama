...
public class WeatherData implements Subject {
    ...
    private ArrayList<Observer> observers; // we add an ArrayList to hold the Observers
    ...
    // returns the most recent weather measurement for temperature, it is used in PULL mode from Observers that are interested
    public double getTemperature(){
        return this.temperature;
    }

    // returns the most recent weather measurement for humidity, it is used in PULL mode from Observers that are interested
    public double getHumidity(){
        return this.humidity;
    }

    // returns the most recent weather measurement for barometric pressure, it is used in PULL mode from Observers that are interested
     ...
     * Because they are all Observers, we know they will implement
     * the update() method so we know how to notify them.
     */
    @Override
